...
describe('NullReturnMutator', () => {
  ...
  describe('backward compatibility (legacy typeTable path)', () => {
    it('Given legacy typeTable setup, When entering return statement, Then creates mutation', () => {
      // Arrange
      const sut = new NullReturnMutator()
      ...
      const returnCtx = TestUtil.createReturnStatement('"Test String"')
    ...
    it('Given legacy typeTable with void method, When entering return statement, Then no mutation created', () => {
      // Arrange
      const sut = new NullReturnMutator()
